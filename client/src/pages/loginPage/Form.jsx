...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    ...
    // parse the response from the server as JSON    const savedUser = await savedUserResponse.json();
          ...
          <Box>
            ...
            {isLogin && (
              <Button
                fullWidth
                onClick={() => {
                  setFieldValue("email", "soniya@gmail.com");
                  setFieldValue("password", "soniya123");
                }}
                sx={{
                  mb: "2rem",
